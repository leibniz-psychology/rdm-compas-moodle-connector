...
if ( ! empty( $licensing_info ) ) {
	 ...
	 */
	printf( esc_html( __( '%1$1s You do not have any extensions activated. %2$2s Please activate any installed extensions. If you do not have any extensions, you can take a look at the list %3$3s here%4$4s.%5$5s', 'rdmcompas-moodle-connector' ) ), '<div class="update-nag"><strong>', '</strong>', '<a href="https://example.com/bridge/extensions/" target="_blank">', '</a>', '</div>' );
}
