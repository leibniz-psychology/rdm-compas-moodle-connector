...
if ( ! class_exists( 'Eb_Settings_Premium_Features' ) ) {
	...
	class Eb_Settings_Premium_Features extends EBSettingsPage {
		...
		public function __construct() {
			$this->_id   = 'pfetures';
			$this->label = __( 'Upgrade to Premium', 'rdmcompas-moodle-connector' );
		...
		public function output() {
			...
			$fetures                     = array(
				array(
					...
					'img'    => plugins_url( 'rdmcompas-moodle-connector/admin/assets/images/ebpf_1.png' ),
					'layout' => 'tr',
				),
				array(
					...
					'img'    => plugins_url( 'rdmcompas-moodle-connector/admin/assets/images/ebpf_2.png' ),
					'layout' => 'tl',
				),
				array(
					...
					'img'    => plugins_url( 'rdmcompas-moodle-connector/admin/assets/images/ebpf_3.png' ),
					'layout' => 'tr',
				),
				array(
					...
					'img'    => plugins_url( 'rdmcompas-moodle-connector/admin/assets/images/ebpf_4.png' ),
					'layout' => 'tl',
				),
			);
			?>
			...
			<div class='ebpf-wrap'>
				<div class='ebpf-header'>
					...
					<div class='ebpf-sub-title'>with the RDM Compas Moodle Connector PRO.</div>
					<a href="https://bit.ly/2NAJ7OW" target="_blank" class="ebpf-hbtn">Upgrade to RDM Compas Moodle Connector PRO</a>
				...
				<div class="ebpf-footer">
					<img class="ebpf-fimg1" src="<?php echo esc_url( plugins_url( 'rdmcompas-moodle-connector/admin/assets/images/ebpf-fbg1.png' ) ); ?>"/>
					<img class="ebpf-fimg2" src="<?php echo esc_url( plugins_url( 'rdmcompas-moodle-connector/admin/assets/images/ebpf-fbg2.png' ) ); ?>"/>
					<div class="ebpf-fcontent">
						<h3>Increase profits by automated course selling with<br/>RDM Compas Moodle Connector PRO</h3>
