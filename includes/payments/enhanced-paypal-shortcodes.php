	...
	function eb_enhanced_paypal_shortcode( $atts ) {
		...
		switch ( $atts['type'] ) {
			...
			<input type="hidden" name="amount" value="' . $atts['amount'] . '">';
				...
				$code .= '<input type="submit" value="' . esc_html__( 'Take this Course', 'rdmcompas-moodle-connector' ) . '"
			...
			alt="" width="1" height="1" class="ppalholder">';
				...
				if ( $atts['imageurl'] ) {
					...
					esc_html__( 'PayPal - The safer, easier way to pay online.', 'rdmcompas-moodle-connector' ) . '" class="ppalbtn">';
				}
